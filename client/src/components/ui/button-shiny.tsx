...
function ButtonCta({ label, children, className, ...props }: ButtonCtaProps) {
    ...
    return (
        ...
        >
            ...
            <div className="relative flex items-center justify-center gap-2">
                <span className="text-lg font-light bg-gradient-to-b from-[#D69DDE] to-[#B873F8] bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(199,135,246,0.4)] tracking-tighter w-full justify-center">
                    {content}
                </span>
            </div>
