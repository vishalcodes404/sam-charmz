...
const SocialIcon = ({ icon: Icon }) => (
    <a href="#" className="w-10 h-10 rounded-full bg-brand-light/5 flex items-center justify-center text-brand-gray hover:bg-brand-primary hover:text-white transition-all duration-300">
        <Icon className="w-5 h-5" />
    </a>
);

const FooterLink = ({ href, text }) => (
    <a href={href} className="hover:text-brand-primary hover:translate-x-1 transition-all duration-300 inline-block">
        {text}
    </a>
);
